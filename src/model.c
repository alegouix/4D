...
int load_wireframe_model(char* filename, Point4D** points, int*** lines, int* n_points, int* n_lines){
    ...
    // char type;
    int np=0, nl=0, i;
    *points = (Point4D*)malloc(sizeof(Point4D)*0);
    *lines = (int**)malloc(sizeof(int*)*0);
    ...
    while (fgets(line, 100, file) != NULL){
        ...
        case 112: //p
            ...
            *points = (Point4D*)reallocarray(*points, np, sizeof(Point4D));
            if (*points == NULL){
            ...
            // printf("%p\n", (*points)[0]);
            // printf("%p\n", (*points)[1]);
            (*points)[np-1] = NewPoint4D(x, y, z, w);
            break;
